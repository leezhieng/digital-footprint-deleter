# Digital Footprint Deleter
**Automate the tedious task of clearing your digital footprint.**<p />

A set of simple browser-based scripts that automatically deletes your social media posts/comments by bulk. It’s secure, no need to share your password or grant special permissions, and includes random delays to mimic human behavior, making it less likely to be flagged as a bot.<p />
